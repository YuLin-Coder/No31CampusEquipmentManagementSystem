package com.camequmansys.camequmansys.utils.qrcode;
...
public class QRCodeUtil {
     ...
     * 生成二维码,返回二维码地址
     */
    public static String QRCodeEncode(String text, String pictureName){
     ...
     * @return
     */
    public static String QRCodeDecode(String picturePath){
        String text = null;
        try {
            text = QRCodeUtil.decode(picturePath);
            return text;
        } catch (Exception e) {
            e.printStackTrace();
            text = "二维码解析失败,请查看是否有误";
            return text;
        }
    }
}
